...
contract BridgeHarness is Bridge {
    ...
    function getUnderlyingAssetOfAToken(address AToken) public returns (IERC20 underlyingAsset) {
        return _aTokenData[AToken].underlyingAsset;
    }

    // Retrieving the LendingPool of the AToken
    function getLendingPoolOfAToken(address AToken) public returns (ILendingPool lendingPool) {
